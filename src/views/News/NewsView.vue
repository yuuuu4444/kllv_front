<script setup>
  ...
  const newsPosts = [
    ...
    {
      id: 6,
      title: '社區夜間照明將升級為 LED，預計 9 月初完工',
      type: 3,
      tag: '施工',
      date: '2025.07.04',
    },
...
<template>
  <MainBanner
    image="/src/assets/banner/banner_news.jpg"
    title="最新消息"
  />
  <div class="container">
