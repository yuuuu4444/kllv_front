  ...
  <div class="report-page">
    ...
    <div class="report-page__container">
      ...
      <div class="report-pagination">
        <button class="report-pagination__prev btn--changepage">&lt;</button>
        <p class="report-pagination__current">2 / 3</p>
        <button class="report-pagination__next btn--changepage">&gt;</button>
      </div>
    </div>
  </div>
</template>
...
<style scoped lang="scss">
  ...
  .report-page {
    ...
    &__banner {
      @include flex-center;
      background-image: url(/src/assets/image/Repair/repair_innerbanner.jpg);
