  ...
  <div class="postsPage">
          ...
          <tbody>
            ...
            >
              ...
              <td class="postTable__cell--action">
                <router-link
                  :to="`/community/post/${post.post_no}/edit`"
    ...
    <div class="postsPage__mobileView">
      ...
      >
        ...
        >
          <router-link
            :to="`/community/post/${post.post_no}`"
    ...
    >
      ...
      <template #default>
        ...
        >
          <!-- 只有未被檢舉的貼文才能編輯 -->
          <router-link
            v-if="!showActionsModalForPost.is_reported"
            :to="`/community/post/${showActionsModalForPost.post_no}/edit`"
