...
<template>
    ...
    <div class="mainbar">
      ...
      <ul class="mainbar__list" role="navigation">
        ...
        <li class="mainbar__item dropdown" @click="openDropdown">
          <a>
            <img src="/src/assets/icon/icon_service.png" alt="service-icon"/>
  ...
  <header class="m">
    <div class="mobilebar">
      ...
      <div class="mobilebar__burger" @click="showPoster">
        <span class="l1"></span>
        <span class="l2"></span>
        <span class="l3"></span>
      </div>
    </div>
    <div class="mposter" :style="{ display: isShow ? 'flex' : 'none' }">
      <div class="mposter__cross" @click="hidePoster">x</div>
      <div class="mposter__top">
        <div class="mposter__images">
          <div class="mposter__image"><img src="/src/assets/image/about_01.jpg" alt="image"></div>
          <div class="mposter__image"><img src="/src/assets/image/about_pear_btn02.jpg" alt="image"></div>
        </div>
      ...
      <div class="mposter__mid-1">
        <div class="mposter__pattern">
          <svg viewBox="0 0 123 124" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="pears" patternUnits="userSpaceOnUse" width="123" height="124">
                  <image href="/src/assets/image/about_03.jpg" x="0" y="0" width="123" height="124"     preserveAspectRatio="xMidYMid slice"/>
                </pattern>
              </defs>
            <path d="M121.923 74.0129C116.777 104.879 83.627 127.608 55.0325 123.525C15.2045 121.483 -4.60633 88.8155 0.90728 60.7416C5.50282 28.0739 34.5597 0 64.7342 0C94.9087 0 129.582 28.0739 121.923 74.0129Z" fill="url(#pears)"/>
          </svg>
        </div>
        <div class="mposter__list">
          <div class="mposter__item">
            <RouterLink to="/events" @click="hidePoster">
              <img src="/src/assets/icon/icon_activity.png" alt="service-icon"/>
              <h5 class="medium">活動報名</h5>
              <img src="/src/assets/icon/icon_arrow-left.svg" alt="arrow-icon">
            </RouterLink>
          </div>
          <div class="mposter__item">
            <RouterLink to="/repair" @click="hidePoster">
              <img src="/src/assets/icon/icon_service.png" alt="service-icon"/>
              <h5 class="medium">維修通報</h5>
              <img src="/src/assets/icon/icon_arrow-left.svg" alt="arrow-icon">
            </RouterLink>
          ...
          <div class="mposter__item">
            <RouterLink to="/community" @click="hidePoster">
              <img src="/src/assets/icon/icon_community.png" alt="community-icon"/>
              <h5 class="medium">里民開講</h5>
              <img src="/src/assets/icon/icon_arrow-left.svg" alt="arrow-icon">
            </RouterLink>
          ...
          <div class="mposter__item">
            <RouterLink to="/login" @click="hidePoster">
              <img src="/src/assets/icon/icon_member.png" alt="members-icon"/>
              <h5 class="medium">里民登入</h5>
              <img src="/src/assets/icon/icon_arrow-left.svg" alt="arrow-icon">
            </RouterLink>
